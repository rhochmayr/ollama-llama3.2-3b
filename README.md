...
```
go run . run --network dev github.com/rhochmayr/ollama-llama3.2-3b:1.0.0 --web3-private-key <admin_key> -i Prompt="your prompt here"
```
...
Example:
```
go run . run --network dev github.com/rhochmayr/ollama-llama3.2-3b:1.0.0 --web3-private-key <admin_key> -i Prompt="A lengthy conversation between two physicists about the latest discovery in quantum technology"
```
...
```
lilypad run github.com/rhochmayr/ollama-llama3.2-3b:1.0.0 -i Prompt="your prompt here"
```

Example:
```
lilypad run github.com/rhochmayr/ollama-llama3.2-3b:1.0.0 -i Prompt="A lengthy conversation between two physicists about the latest discovery in quantum technology"
```
